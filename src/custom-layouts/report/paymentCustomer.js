...
export default function CreatePaymentCustomerForm() {
  ...
  const exportSimpleExcel = async (fromDate, toDate, customerId) => {
    ...
    const worksheet = workbook.addWorksheet("PaymentCustomer Report");

    worksheet.columns = [
      { header: "No", key: "no", width: 10 },
      { header: "PaymentCustomer Order", key: "name", width: 30 },
    ...
    saveAs(blob, "paymentCustomer.xlsx");
